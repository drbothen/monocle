...
next_session_resume_protocol: |
  ============================================================================
  ZERO-CONTEXT RESUME CHECKPOINT v7.43 (D-271..D-293) — 2026-06-14
  PIVOT: monocle → full TUI control center — PHASE-1D ADV CONVERGENCE IN PROGRESS
  50 PASSES COMPLETE; CONSECUTIVE-CLEAN COUNTER = 0; PASS-51 NEXT (clean candidate 1 of 3)
  ============================================================================
  ...
  50 adversarial passes complete on the v1A control-center spec package.
  Finding trajectory (Critical / Important per pass):
    ...
    Pass 50: 0C/1I FINDINGS (D-293 — F-P50-001: host_conn-lifecycle contradiction for
             ...
             v1.23.0, SS-session-manager v2.5.0, SS-daemon-wiring-v2-delta v1.11.1,
  ...
  Passes 7 through 50 ALL ZERO-Critical except Pass 29 (C29-001) and Pass 34 (C34-001).
  CONSECUTIVE-CLEAN COUNTER = 0. Pass-51 = clean candidate 1 of 3.
  NEXT = adversarial Pass 51.
  ...
  Architecture subsystem specs (delta docs — all v1A pivot additions):
    SS-ipc v1.23.0                        (23 IPC variants + SpawnAck; 12-code taxonomy; spawn_unsupported + session_not_ready wire codes; SpawnSession{opts}; #[ne] PermissionDecisionKind; F-P41+F-P44+F-P50)
    SS-session-manager v2.5.0             (spawn_session(opts); SpawnOptions split; EngineError bridge; KeyInput error path; IPC handler UUID locus + SpawnAck send; UnsupportedOperation arm; SessionNotReady arm; host_conn.writer during Launching; proxy_task Option<JoinHandle<()>>)
    ...
    SS-daemon-wiring-v2-delta v1.11.1    (daemon coordinator; IPC SpawnSession arm + 4-step SpawnAck sequence; ordered-pair-split rationale; ADR-0006 constructors; UnsupportedOperation error-table row; SessionNotReady error-table row)
  ...
  Behavioral Contracts:
    BC-INDEX v1.40.8  (138 BCs total; 25 new v1A BCs)
    SS-03: BC-2.03.005 v1.1.3, BC-2.03.006 v1.1.1, BC-2.03.007 v1.2.2, BC-2.03.008 v1.0.3
    SS-05: BC-2.05.009 v1.5.2, BC-2.05.010 v1.9.0, BC-2.05.011 v1.2.1
    ...
    SS-08: BC-2.08.001 v1.5.0, BC-2.08.002 v1.2.1, BC-2.08.003 v1.4.0, BC-2.08.004 v1.2.1,
           BC-2.08.005 v1.0.1, BC-2.08.006 v1.2.1, BC-2.08.007 v1.5.0, BC-2.08.008 v1.2.1
  ...
  ENGINEERROR WIRE-CODE TAXONOMY (Pass-44, D-287; extended Pass-50, D-293 — CLOSED):
    ...
    Spec: SS-ipc v1.23.0, SS-session-manager v2.5.0, SS-engine-module-v2-delta v1.6.0,
    SS-daemon-wiring-v2-delta v1.11.1, BC-2.08.003 v1.4.0, BC-2.05.010 v1.9.0,
    BC-2.08.007 v1.5.0, BC-2.03.008 v1.0.3, BC-INDEX v1.40.8.
