...
next_session_resume_protocol: |
  ...
  DEFERRED ITEMS — DO NOT RE-FLAG IN PASS 29:
    ...
    F-S025-ADV28-OBS-001 [Pattern-of-Patterns architect protocol] (Task #9 m.9 — defer unless 4th ADR defect fires)
  ...
  AFTER CONVERGENCE (3/3 NITPICK_ONLY-CLEAN):
    ...
    Task #9 batch: story-writer template (m.3), PO BC template (m.4), CODIFY-001 sunset doc (m.5),
      S-028 cross-story sweep (m.8), architect protocol improvement (m.9).
