...
next_session_resume_protocol: |
  ...
  CRITICAL FILES FOR PASS 24 ADVERSARY (read in order):
    ...
    4. adversarial-pass-21.md; 5. adversarial-pass-20.md; 6. adversarial-pass-19.md;
    ...
    15. .factory/stories/S-025-tui-skeleton-sessions.md (v1.7);
    16. CLAUDE.md (project principles — production-grade default).
    All cycle files at: .factory/cycles/cycle-001/S-025/

  ADV16-CODIFY-001 8-CATEGORY SWEEP (D-198.2 + D-201 + D-202 EXTENDED):
