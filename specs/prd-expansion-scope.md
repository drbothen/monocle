...
## §Trace v1.3 — POL-11 version-pin cascade from product-brief v1.4.34 (2026-05-30)

**Bump:** 1.2 → 1.3.
**Scope:** `traces_to:` and body prose §1 line 2: `product-brief.md v1.4.33` → `product-brief.md v1.4.34` (Option 1 per ADR-0007 §Decision — live active pointer; product-brief bumped to v1.4.34 during BC-2.06.007 terminology correction cascade).
