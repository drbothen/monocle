...
| Forward-compatibility contracts | All 6 FC items shipped | 22 BCs active in PRD: BC-2.02.001/002 (ABI), BC-2.02.003 (Types), BC-2.02.004/005 (Factory), BC-2.02.006/007/008 (Proto), BC-2.01.007 (Ring), BC-2.01.008/009 (Auth), BC-2.03.001/002/003/004 (Engine), BC-2.01.010 (Lock). Per BC-INDEX v1.35. |
...
The 22 BCs covering these contracts (per BC-INDEX v1.35) are preserved. New v1A BCs will be
