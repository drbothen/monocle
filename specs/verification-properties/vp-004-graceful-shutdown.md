...
- **Traces to (historical):** BC-DAEMON-004 (PRD v1.25 §BC-DAEMON-004;
  SS-daemon-lifecycle.md v1.0.30 §Shutdown Signal Handling, §Drain,
  §Hard Shutdown).
...
- `tokio::signal::unix::signal(SignalKind::terminate())` is the SIGTERM
  ...
  selection (per arch v1.0.30 §Hard Shutdown step 6d).
...
- PRD: `.factory/specs/prd.md` v1.26.5 §BC-2.01.004 (Dispatch 4 commit 1030c65; refreshed to v1.26.5 in F-R107-3 / GAP-R46-1 closure, parallel PO 6B dispatch — commit pending; supersedes v1.26.4 commit 01af634 pre-R107 fix burst + v1.26.3 commit b2b378b F-R105-12 closure).
