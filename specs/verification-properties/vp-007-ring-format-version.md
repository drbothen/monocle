...
4. **Absence-of-field for `None` Options (BC-2.01.007 EC-001 normative
   ...
   on `tool_name` and `tool_input` (per arch v1.0.30 commit pending
...
- Architecture: `architecture/SS-daemon-lifecycle.md` v1.0.30 §Drain (commit
  pending — architect 5E F-FC-I005 removal + dual-accept consolidation).
- PRD: `.factory/specs/prd.md` v1.26.5 §BC-2.01.007 (Dispatch 4 commit 1030c65; refreshed to v1.26.5 in F-R107-3 / GAP-R46-1 closure, parallel PO 6B dispatch — commit pending; supersedes v1.26.4 commit 01af634 pre-R107 fix burst + v1.26.3 commit b2b378b F-R105-12 closure).
