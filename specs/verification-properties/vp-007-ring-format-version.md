...
- Architecture: `architecture/SS-daemon-lifecycle.md` v1.0.31 §Drain (commit
  98396fe — Architect 6D SS pin bump; Architect 7C keeps at v1.0.31).
- PRD: `.factory/specs/prd.md` v1.26.6 §BC-2.01.007 (Dispatch 4 commit 1030c65; refreshed to v1.26.6 in R108 Round 7B PO dispatch — commit pending; supersedes v1.26.5 in F-R107-3 / GAP-R46-1 closure commit d92e4a7; supersedes v1.26.4 commit 01af634 pre-R107 fix burst + v1.26.3 commit b2b378b F-R105-12 closure).
