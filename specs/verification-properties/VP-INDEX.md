...
- **BC-INDEX:** `behavioral-contracts/BC-INDEX.md` v1.9 (commit c0c6b99 — PO 10A R111 Round 10A timestamp pathology fix + L2-INDEX v1.0.8 pin refresh). <!-- version-pin-historical: round-log provenance record (R20A/R20B/R19A dispatch chain) -->
...
## §Trace v1.14 — R18E Round 18E FV Cleanup: SM-Surfaced VP-INDEX BC-INDEX Cite Staleness Closure + 22-VP Cascade (BC-INDEX v1.11 + PRD v1.26.12; SE-22 v2 Consumer-Ledger 2nd Explicit Occurrence) <!-- version-pin-historical: round-log provenance record (R20A/R20B/R19A dispatch chain) -->
...
- **Architecture (SS-02):** `architecture/SS-core-types-and-abi.md` v1.2.13 (unchanged this round).
- **Architecture (SS-03):** `architecture/SS-engine-module.md` v1.1.20 (unchanged this round).
- **R18 chain (this burst is R18E):** R18-pre SE-23 codify (70b7552) → R18A PRD v1.26.12 (92c55d2) → R18B BC-INDEX v1.11 (442f5ac) → R18C L2-INDEX v1.0.10 (bedcf30) → R18D STATE v5.80 closure (2ae9272) → R18E VP-INDEX + 22 VP §References cascade (THIS burst) → R120 adversary dispatch (next phase). <!-- version-pin-historical: round-log provenance record (R20A/R20B/R19A dispatch chain) -->
...
**Bump:** v1.14 → v1.15.
**Predecessor pin:** v1.14 (commit b22312c — R18E Round 18E FV cleanup: VP-INDEX + 22 VP §References cascade-tail refresh to BC-INDEX v1.11 + PRD v1.26.12; SE-22 v2 consumer-ledger 2nd explicit occurrence). <!-- version-pin-historical: round-log provenance record (R20A/R20B/R19A dispatch chain) -->
...
- R19A: PRD v1.26.12 → v1.26.13 (commit ce1e0ca — F-R120-1/2/3 compound closure: PRD traces_to BC-INDEX v1.11 + L2-INDEX v1.0.10 + VP-INDEX v1.14 + 2 SS pins + 5 pinned ADRs; SE-22 v2 first application). <!-- version-pin-historical: round-log provenance record (R20A/R20B/R19A dispatch chain) -->
...
- R19D: L2-INDEX v1.0.10 → v1.0.11 + CAP-001 v1.5 → v1.6 (commit 6b85e06 — combined BA brief consumer-ledger closure: L2-INDEX line 149 + CAP-001 §Trace v1.6 brief v1.4.30 fan-out). <!-- version-pin-historical: round-log provenance record (R20A/R20B/R19A dispatch chain) -->
- R19E: PRD v1.26.13 → v1.26.14 (commit 31f984a — comprehensive PRD refresh: traces_to brief v1.4.30 + L2-INDEX v1.0.11; supersedes v1.26.13 intermediate). <!-- version-pin-historical: round-log provenance record (R20A/R20B/R19A dispatch chain) -->
...
3. **Application #3 (R19D):** L2-INDEX v1.0.10 → v1.0.11 + CAP-001 v1.5 → v1.6 combined BA dispatch enumerated PRD consumer; commit 6b85e06. <!-- version-pin-historical: round-log provenance record (R20A/R20B/R19A dispatch chain) -->
...
- **PRD:** `.factory/specs/prd.md` v1.26.14 (R19E commit 31f984a — comprehensive PRD refresh: traces_to brief v1.4.30 + L2-INDEX v1.0.11; supersedes v1.26.13 R19A commit ce1e0ca — F-R120-1/2/3 compound closure; supersedes v1.26.12 R18A commit 92c55d2). <!-- version-pin-historical: round-log provenance record (R20A/R20B/R19A dispatch chain) -->
...
- **Architecture (SS-02):** `architecture/SS-core-types-and-abi.md` v1.2.13 (unchanged this round).
- **Architecture (SS-03):** `architecture/SS-engine-module.md` v1.1.20 (unchanged this round).
- **R19 chain (this burst is R19F):** R19-pre SE-22 v2 codify (646c949) → R19A PRD v1.26.13 (ce1e0ca) → R19B brief v1.4.30 (6c863a9) → R19D L2-INDEX v1.0.11 + CAP-001 v1.6 (6b85e06) → R19E PRD v1.26.14 (31f984a) → R19F VP-INDEX + 22 VP §References cascade (THIS burst) → adversary R60 dispatch (next phase). <!-- version-pin-historical: round-log provenance record (R20A/R20B/R19A dispatch chain) -->
...
- **SE-17f §References PRD line:**
  ...
  - After: `PRD: \`.factory/specs/prd.md\` v1.26.15 (Dispatch 4 commit 1030c65; refreshed to v1.26.15 in R20A R20A PO dispatch commit 68863bd — F-R121-1 / GAP-R60-001 reverse-cascade closure: traces_to VP-INDEX v1.14 → v1.15; supersedes v1.26.14 in R19E R19E PO dispatch commit 31f984a — ...; supersedes v1.26.13 in R19A R19A PO dispatch commit ce1e0ca — ...; supersedes v1.26.12 in R18A R18A PO dispatch commit 92c55d2 ...).` <!-- version-pin-historical: round-log provenance record (R20A/R20B/R19A dispatch chain) -->
...
**POL-11 version-pin remediation — References historical-anchor annotation** (2026-05-30):
- BC index line: added `<!-- version-pin-historical -->` to BC-INDEX v1.11 / L2-INDEX v1.0.8 historical provenance (Option 3 per ADR-0007 §Historical Anchor Classification — documents state at R18B dispatch time).
- PRD line: added `<!-- version-pin-historical -->` to BC-INDEX v1.11, L2-INDEX v1.0.10, VP-INDEX v1.14 historical provenance (documents state at R20A/R19A/R19E dispatch time).
- Current as of line: added `<!-- version-pin-historical -->` to VP-INDEX v1.14 → v1.15 supersession reference (historical chain).
- Version bump: 1.16 → 1.17.
- SE-16d PASS: 2026-05-30 >= 2026-05-19T03:30:00Z (patch; no normative content change).
