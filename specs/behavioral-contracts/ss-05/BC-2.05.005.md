...
| Architecture Source | SS-ipc.md v1.10.0 §Message Types §Server-to-Client Messages; SS-ipc.md v1.10.0 §Connection Lifecycle §Phase 2 Streaming Updates; SS-ipc.md v1.10.0 §Risk Mitigations §Multiple TUI Clients Resolving the Same Prompt |
