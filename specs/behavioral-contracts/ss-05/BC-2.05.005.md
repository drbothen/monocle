...
| Architecture Source | SS-ipc.md v1.12.1 §Message Types §Server-to-Client Messages; SS-ipc.md v1.12.1 §Connection Lifecycle §Phase 2 Streaming Updates; SS-ipc.md v1.12.1 §Risk Mitigations §Multiple TUI Clients Resolving the Same Prompt |
