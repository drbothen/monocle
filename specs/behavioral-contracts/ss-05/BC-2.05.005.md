...
| Architecture Source | SS-ipc.md §Message Types §Server-to-Client Messages; SS-ipc.md §Connection Lifecycle §Phase 2 Streaming Updates; SS-ipc.md §Risk Mitigations §Multiple TUI Clients Resolving the Same Prompt |
