...
| Architecture Source | SS-tui.md v1.8.2 §Permission Overlay §Overlay Stack Lifecycle; SS-ipc.md v1.14.0 §ServerToClient::PermissionPromptResolved (lines 288-289 debounce; message type definition) |
