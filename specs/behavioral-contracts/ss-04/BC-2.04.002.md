...
| Capability Anchor Justification | CAP-001 ("Daemon Lifecycle") per CAP-001-daemon-lifecycle.md — this BC governs the auto-start decision that bootstraps the daemon lifecycle on every TUI launch, which is the primary user-facing entry point to daemon lifecycle management |
...
| Architecture Source | SS-daemon-wiring.md v1.0.0 §Daemon Auto-Start Logic §Auto-Start Decision Sequence (BC-2.04.002) |
