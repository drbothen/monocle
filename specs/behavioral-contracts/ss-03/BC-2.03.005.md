...
| Architecture Source | SS-engine-module-v2-delta.md v1.0.1 §ClaudeCodeModule::spawn_recipe() implementation spec; SS-session-manager.md v1.0.1 §SpawnRecipe integration with EngineModule |
