...
| Architecture Source | SS-engine-module-v2-delta.md v1.1.0 §ClaudeCodeModule::spawn_recipe() implementation spec; SS-session-manager.md v1.4.1 §SpawnRecipe integration with EngineModule |
...
- I2-002 finding: BC-2.03.005 set `recipe.cwd = opts.project_root` (incorrect). The
  architecture (SS-session-manager.md v1.4.1 §SpawnRecipe integration) specifies that
