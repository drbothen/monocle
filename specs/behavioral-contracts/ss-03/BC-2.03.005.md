...
| Architecture Source | SS-engine-module-v2-delta.md v1.3.0 §ClaudeCodeModule::spawn_recipe() implementation spec; SS-session-manager.md v2.1.0 §SpawnRecipe integration with EngineModule |
