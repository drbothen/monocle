...
| Architecture Source | SS-engine-module-v2-delta.md v1.2.0 §ClaudeCodeModule::spawn_recipe() implementation spec; SS-session-manager.md v2.0.0 §SpawnRecipe integration with EngineModule |
