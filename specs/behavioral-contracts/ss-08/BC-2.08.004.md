...
| Architecture Source | SS-session-manager.md v1.0.1 §Daemon startup: session re-discovery; SS-daemon-wiring-v2-delta.md v1.0.1 §daemon_start_sequence() — session re-discovery step (step 8b placement and insertion invariant) |
