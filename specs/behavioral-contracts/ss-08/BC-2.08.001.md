...
5. `ServerToClient::SessionStateChanged { session_id, new_state: Launching }` is published
   ...
   mutex per BC-2.08.008 Invariant 4 and SS-daemon-wiring-v2-delta.md v1.12.0 §3b).
...
- SE-16d monotonicity: 1.5.8 > 1.5.7. PASS.
...
- SE-16d monotonicity: v1.5.7 > v1.5.6. PASS.
...
- SE-16d monotonicity: v1.5.4 timestamp 2026-06-19 >= v1.5.3 timestamp auto. PASS.
