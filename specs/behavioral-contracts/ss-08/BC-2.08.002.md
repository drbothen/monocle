...
| Architecture Source | SS-session-manager.md v2.1.0 §Daemon startup: session re-discovery; SS-session-manager.md v2.1.0 §monocle-session-host binary §startup sequence step 2; ADR-0009 v1.0.2 §Decision |
