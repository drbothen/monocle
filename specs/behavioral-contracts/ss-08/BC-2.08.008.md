...
- SE-16d monotonicity: 1.4.4 > 1.4.3. PASS.
...
- SE-16d monotonicity: 1.4.3 > 1.4.2. PASS.
...
- SE-16d monotonicity: v1.4.2 > v1.4.1. PASS.
...
- SE-16d monotonicity: v1.4.1 timestamp >= v1.4.0. PASS.
...
- SE-16d monotonicity: v1.4.0 timestamp >= v1.3.9. PASS.
...
**SS-session-manager v2.13.0 → v2.13.0 Architecture Source pin cascade (F-S035-PASS2-LOW-001)** (2026-06-19T00:00:00Z):
- Architecture Source pin SS-session-manager.md v2.13.0 → v2.13.0 (v2.13.0 adds the
  uid-mismatch/protocol-error subpath split in the attach_session Detached cell of the
  Terminated-in-grace action×state matrix — F-S035-PASS2-LOW-001). No behavioral content
  changes to this BC.
- SE-16d monotonicity: v1.3.6 timestamp 2026-06-19 >= v1.3.5 timestamp 2026-06-18. PASS.
...
- SE-16d monotonicity: v1.3.3 timestamp >= v1.3.2. PASS.
