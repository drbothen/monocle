...
2. `ServerToClient::SessionStateChanged { session_id, new_state: Terminating }` is published
   ...
   mutex per BC-2.08.008 Invariant 4 and SS-daemon-wiring-v2-delta.md v1.12.0 §3b. TUI renders
...
5. **SO_PEERCRED applies to EVERY per-session UDS fresh-connect — no coverage holes:**
   ...
   started). Per SS-session-manager.md §Per-session UDS security item 1: "SO_PEERCRED
...
- SE-16d monotonicity: 1.5.5 > 1.5.4. PASS.
...
- SE-16d monotonicity: v1.5.4 > v1.5.3. PASS.
...
- SE-16d monotonicity: v1.5.2 timestamp 2026-06-19 >= v1.5.1 timestamp 2026-06-19. PASS.
