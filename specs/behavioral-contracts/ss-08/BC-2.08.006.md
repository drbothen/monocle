...
| Architecture Source | SS-session-manager.md v2.17.1 §SpawnRecipe integration with EngineModule (single-writer mandate, HookEndpointConfig construction); SS-engine-module-v2-delta.md v1.6.0 §Hook auto-injection invariant; SS-daemon-wiring-v2-delta.md v1.12.0 §lifecycle step 9 single-writer call; BC-HOOK-027; BC-HOOK-028 |
