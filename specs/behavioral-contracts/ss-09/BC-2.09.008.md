...
| Architecture Source | SS-embedded-pty.md v1.5.1 §TUI AppMode Extensions (EmbeddedTerminal, SessionCreation, SessionCreationStep); §Session Creation Wizard; §State machine invariants |
