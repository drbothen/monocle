...
| Architecture Source | SS-embedded-pty.md v1.5.0 §PTY Widget Pipeline; §Parser ownership in TUI; §O4 memory bound; §I7 per-session scroll offset; §EmbeddedTerminal ENTRY (auto-attach mandate, I11-001 PRONG A); SS-session-manager.md v1.8.1 §Screen-state transfer (C5); ADR-0011 v1.2.0 §Decision |
