...
| Architecture Source | SS-embedded-pty.md v1.3.0 §PTY Widget Pipeline; §Parser ownership in TUI; §O4 memory bound; §I7 per-session scroll offset; SS-session-manager.md v1.6.0 §Screen-state transfer (C5); ADR-0011 §PTY stack selection |
