...
| Architecture Source | SS-embedded-pty.md v1.3.0 §State machine invariants (permission prompts while in EmbeddedTerminal; SUG-3 fix); §BC requirement flag (v1B pre-emption deferred) |
