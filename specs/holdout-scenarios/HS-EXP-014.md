...
does not exist in session-state.json schema v2 per SS-session-manager v1.7.0).
...
That field does not exist in the session-state.json schema (SS-session-manager v1.7.0 §session-
