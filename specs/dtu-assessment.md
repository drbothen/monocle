...
any-context ingest) and monocle-canonical fields (from SS-core-types-and-abi.md v1.2.5 struct
...
| Hook type | HTTP method | Path | Auth header | Gene-source body fields (BC-HOOK-007) | Monocle-canonical body fields (SS-core-types-and-abi.md v1.2.5) |
|-----------|-------------|------|-------------|--------------------------------------|------------------------------------------------------------------|
...
SS-core-types-and-abi.md v1.2.5 §Non-Exhaustive Inner Structs — the authoritative Rust struct
