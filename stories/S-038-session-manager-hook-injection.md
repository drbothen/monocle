...
# BC status: BC-2.08.006 v1.4.1 — non-empty; status draft pending Phase-2 adversarial convergence gate
---
...
- BC-2.08.006 v1.4.1 references "BC-2.04.010 (not BC-HOOK-007)" as the authority for hook
