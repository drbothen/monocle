...
### AC-001 (traces to BC-2.06.022 postcondition PC-1 — test scenario setup)
...
### AC-002 (traces to BC-2.06.022 postcondition PC-2 — prompt E2E: queued → resolved)
...
### AC-003 (traces to BC-2.06.022 postcondition PC-3 — multi-prompt stacking)
...
### AC-004 (traces to BC-2.06.022 postcondition PC-4 — disconnect clears overlay mid-prompt)
...
### AC-005 (traces to BC-2.06.022 postcondition PC-5 — Esc does not reject)
...
### AC-006 (traces to BC-2.06.022 postcondition PC-6 — Edit diff rendered in test)
...
### AC-007 (traces to BC-2.06.022 invariant INV-1 — test isolation)
...
Files to create:
- `monocle-tui/tests/killer_scenario.rs` — all 6 killer scenario test cases
