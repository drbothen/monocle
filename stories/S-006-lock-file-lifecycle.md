...
priority: P0
depends_on: [S-001]
blocks: [S-005, S-007, S-008, S-009, S-016, S-017]
...
**Phase 3.B Batch 6 — S-005 dependency cascade (bidirectional symmetry)** (2026-05-20):
- F-E-02 symmetric update: S-005 added to `blocks:` ([S-007, S-008, S-009] → [S-005, S-007,
  S-008, S-009]). Justification: S-005 lifecycle::exit_with() calls DaemonLock::release()
  from lock.rs (S-006 deliverable) before process termination per BC-2.01.004 PC-7.
- No content changes to AC, Tasks, or other sections in this burst.
