...
fn clone_action(action: &Action) -> Action {
    match action {
        ...
        // S-043 (BC-2.09.007): PTY scrollback navigation — per-context EmbeddedTerminal bindings.
        Action::PtyScrollUp => Action::PtyScrollUp,
        Action::PtyScrollDown => Action::PtyScrollDown,
